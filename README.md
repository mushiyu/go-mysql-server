...
<a href="https://godoc.org/github.com/mushiyu/go-mysql-server"><img alt="GoDoc" src="https://godoc.org/github.com/mushiyu/go-mysql-server?status.svg" /></a>
[![Issues](http://img.shields.io/github/issues/src-d/go-mysql-server.svg)](https://github.com/mushiyu/go-mysql-server/issues)
...
The import path for the package is `github.com/mushiyu/go-mysql-server`.

To install it, run:

```
go get github.com/mushiyu/go-mysql-server
```

## Documentation

* [go-mysql-server godoc](https://godoc.org/github.com/mushiyu/go-mysql-server)
...
Taking a look at the main [index interface](https://github.com/mushiyu/go-mysql-server/blob/master/sql/index.go#L35), you must note a couple of constraints:
